...
void mfe::buildLocalF(int ielem, double r1, double r2, double r3, double z1, double z2, double z3, double detD, double dt, double t, double q0[3])
{
	...
	b_loc[0] = c[0] * p_loc + M[0][0] * q0[0] + M[0][1] * q0[1] + M[0][2] * q0[2];
	b_loc[1] = c[1] * p_loc + M[1][0] * q0[0] + M[1][1] * q0[1] + M[1][2] * q0[2];
	b_loc[2] = c[2] * p_loc + M[2][0] * q0[0] + M[2][1] * q0[1] + M[2][2] * q0[2];
